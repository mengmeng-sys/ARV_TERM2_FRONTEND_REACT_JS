...
import { registerUser, setCurrentUser } from "../data/store.js";
        ...
        <div className="reg-card">
          <div className="reg-form-panel">
            ...
            <p className="reg-subtitle">
              Already have account? <Link to="/SignIn"><a href="#">Sign In.</a></Link>
            </p>
            ...
            <div className="field-row">
              <div className="field no-mb">
                ...
                <div className="input-wrap"><span className="input-icon"><UserIcon /></span>
                  <input type="text" name="firstName" placeholder="John" value={form.firstName} onChange={handleChange} /></div>
              </div>
              <div className="field no-mb">
                <label>Last name</label>
                <div className="input-wrap"><span className="input-icon"><UserIcon /></span>
                  <input type="text" name="lastName" placeholder="Doe" value={form.lastName} onChange={handleChange} /></div>
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="input-wrap"><span className="input-icon"><MailIcon /></span>
                <input type="email" name="email" placeholder="hello@example.com" value={form.email} onChange={handleChange} /></div>
            </div>

            <div className="field">
              <label>Phone number</label>
              <div className="input-wrap"><span className="input-icon"><PhoneIcon /></span>
                <input type="tel" name="phone" placeholder="+1 234 567 890" value={form.phone} onChange={handleChange} /></div>
            </div>
            ...
            <div className="field">
              ...
              <div className="input-wrap"><span className="input-icon"><LockIcon /></span>
                ...
                <button className="input-eye" onClick={() => setShowPass(!showPass)}><EyeIcon open={showPass} /></button>
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="input-wrap"><span className="input-icon"><LockIcon /></span>
                <input type={showConfirm ? "text" : "password"} name="confirm" placeholder="Repeat password" value={form.confirm} onChange={handleChange} />
                <button className="input-eye" onClick={() => setShowConfirm(!showConfirm)}><EyeIcon open={showConfirm} /></button>
              </div>
            </div>
          ...
          <div className="reg-image-panel">
            <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&q=80" alt="ARV fashion" />
            <div className="image-label"><span>ARV Studios</span>Arrive in Style</div>
          </div>
        </div>
      </div>
      <Footer />
